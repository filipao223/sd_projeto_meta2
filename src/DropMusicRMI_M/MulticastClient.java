...
public class MulticastClient extends Thread {//RECEBER
    ...
    synchronized public void run() {
        ...
        try {
            ...
            while (true) {
                ...
                /*while(packet.getPort() == socket.getLocalPort()) {
                    buffer = new byte[256];
...
class MulticastUser extends Thread {//ENVIAR
    ...
    public synchronized void run() {
        ...
        try {
            ...
            System.out.println("*ENVIAR "+socket.getLocalPort()+"*");
